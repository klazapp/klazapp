...
<picture>
  ...
  <img src="assets/hero-light.svg" alt="Klaus Vinn — Software Engineering &amp; Technical Delivery. From the frame to the system." width="100%">
</picture>
...
<picture>
  ...
  <img src="assets/scan-light.svg" alt="Package Scan — conceptual project illustration." width="100%">
</picture>
      </a>
      <h3><a href="https://github.com/klazapp/typescript-package-scan">Package Scan ↗</a></h3>
      <p>Check a dependency tree against a configurable list of packages and versions, with machine-readable reports and CI exit codes.</p>
      <p><strong>Look inside:</strong> Explicit matching rules, dependency paths and actionable results.</p>
      <p><sub>TypeScript · CLI · Dependency tooling</sub></p>
    </td>
    <td width="50%" valign="top">
...
<picture>
  ...
  <img src="assets/graph-light.svg" alt="Dynamic Navigation — conceptual project illustration." width="100%">
</picture>
      </a>
      <h3><a href="https://github.com/klazapp/UNITY-GridBased-Pathfinding">Dynamic Navigation ↗</a></h3>
      <p>A navigation graph that changes with the world, with a scene-independent C# core and event-driven route recalculation.</p>
      <p><strong>Look inside:</strong> Boundaries between topology, route finding and scene behaviour.</p>
      <p><sub>C# · Graphs · Unity</sub></p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
...
<picture>
  ...
  <img src="assets/render-light.svg" alt="Instanced Rendering — conceptual project illustration." width="100%">
</picture>
      </a>
      <h3><a href="https://github.com/klazapp/UNITY-DMICustomDrawCall-Jobified">Instanced Rendering ↗</a></h3>
      <p>Custom culling and mesh instancing, with jobified transform updates and per-instance material properties.</p>
      <p><strong>Look inside:</strong> The relationship between visibility, CPU work and draw submission.</p>
      <p><sub>C# · Unity Jobs · Burst</sub></p>
    </td>
    <td width="50%" valign="top">
      <a href="https://github.com/klazapp/bento-grid-builder">
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/bento-dark.svg">
  <img src="assets/bento-light.svg" alt="Bento Grid Builder — conceptual project illustration." width="100%">
</picture>
      </a>
      <h3><a href="https://github.com/klazapp/bento-grid-builder">Bento Grid Builder ↗</a></h3>
      <p>Configurable React layouts with responsive presets and explicit mappings between application data and card components.</p>
      <p><strong>Look inside:</strong> Separation of layout, data and rendering responsibilities.</p>
      <p><sub>React · TypeScript · UI systems</sub></p>
    </td>
  </tr>
</table>
...
<picture>
  ...
  <img src="assets/impact-light.svg" alt="Previously led a 13-member cross-functional team. Delivered 15+ enterprise releases. One mobile title exceeded 100,000 organic downloads." width="100%">
</picture>
...
<details>
<summary><strong>Tools & credentials</strong></summary>
...
<p align="center">
  <strong>Good software is more than the code that runs.</strong><br>
  <sub>It is also the clarity, decisions and delivery behind it.</sub>
</p>
